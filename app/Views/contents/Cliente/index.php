<div class="content p-4 dataTables_wrapper">
    <h2 class="mb-4">Gestión de Cliente</h2>
        ...
        <div class="card-header bg-white">
          ...
          <?php $band = false;
                foreach ($_SESSION['permisos'] as $p):
                    if ($p->permiso == "Registrar Clientes") {     
                        $band = true;
                }endforeach;     
                if (!$band) {
                    echo "disabled";
    ...
    <!-- Modal mostrar -->
    <div class="modal fade" id="modalMostrarCliente" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formularioMostrarCliente">
                            <div class="row form-group">
    ...
    <!-- Modal actualizar -->
    <div class="modal fade" id="modalActualizarCliente" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="#" method="POST" enctype="multipart/form-data" id="formularioActualizarCliente">
                            <div class="row form-group">
                                <input  name="id" id="id" hidden>
                                <label for="nombre" class="col-form-label col-md-2">Nombre:</label>
                                <div class="col-md-4 ">
